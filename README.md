Este repositorio contiene los datos en un archivo CSV y dos archivos de codigo (.ipynb y .py) para ejecutar en el ambiente Google Colab se recomienda usar el archivo Prueba_tic_7.ipynb
